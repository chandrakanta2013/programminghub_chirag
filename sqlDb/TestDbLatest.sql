...
INSERT INTO `program` VALUES (1,'Fibonaucci','maths',1,NULL,NULL),(2,'Prime Number','maths',3,NULL,NULL),(3,'Swap','mathss',2,NULL,NULL),(4,'Kishan Maheshwary',NULL,2,NULL,NULL),(5,'Abhinav Rajpurohit','IndiaNIC',1,NULL,NULL),(6,'Abhinav Rajpurohit','IndiaNIC',3,NULL,NULL),(7,'Milan Rajpurohit','IndiaNIC123',3,NULL,NULL),(8,'Milan Rajpurohit','IndiaNIC123',3,NULL,NULL),(9,'Milan Rajpurohit','IndiaNIC123',1,NULL,NULL),(10,'Panakaj Sharma','Punewale',1,NULL,NULL),(11,'Bag','Fibonaucci',3,NULL,NULL),(12,'Tarak','Wordpress',2,NULL,NULL),(13,'Tarak','Wordpress',2,NULL,NULL),(14,'Tarak','Wordpress',2,NULL,NULL),(15,'Tarak','Wordpress',2,NULL,NULL),(16,'Tarak','Wordpress',2,NULL,NULL);
...
INSERT INTO `program_details` VALUES (1,4,2,'Hello my name is Abhinav','Hello!!!','Follow','Yes',4,'Correct','Yes','Yes'),(3,5,1,'Moon','Sub','Airplane','Not',5,'Correct','No','Yes'),(4,1,2,'Ballh','g','Train','No',3,'Wrong','Yes','No'),(5,1,1,'Ballw','fb','rbfg','No',3,'Wrong','Yes','No'),(6,1,3,'Ballx','ff','fh','No',3,'Wrong','Yes','No'),(7,1,2,'Ballsd','rh','vb','No',3,'Wrong','Yes','No'),(8,1,3,'Ball','Bat','Train','No',3,'Wrong','Yes','No'),(9,NULL,6,'My',NULL,NULL,'Ahmedabad',4,NULL,'Hello',NULL),(10,NULL,7,'My SELF',NULL,NULL,'AhmedabadBBBBB',5,NULL,'HOLA',NULL),(11,NULL,8,'My SELF',NULL,NULL,'AhmedabadBBBBB',5,NULL,'HOLA',NULL),(12,NULL,9,'My SELF',NULL,NULL,'AhmedabadBBBBB',5,NULL,'HOLA',NULL),(13,NULL,10,'MINE',NULL,NULL,'Pune',9,NULL,'No',NULL),(14,NULL,11,'Samkjdar',NULL,NULL,'Bangalore',10,NULL,'Yes',NULL),(15,NULL,12,'AngularJS',NULL,NULL,'ADI',5,NULL,'No',NULL),(16,NULL,13,'AngularJS',NULL,NULL,'ADI',5,NULL,'No',NULL),(17,NULL,14,'AngularJS',NULL,NULL,'ADI',5,NULL,'No',NULL),(18,NULL,15,'AngularJS',NULL,NULL,'ADI',5,NULL,'No',NULL),(19,NULL,16,'AngularJS',NULL,NULL,'ADI',5,NULL,'No',NULL);
...
INSERT INTO `program_io` VALUES (1,3,'number','string'),(2,1,'char','float'),(3,8,'string','parse'),(4,5,'stringsdf','parserty'),(5,7,'stringwer','parsegh'),(6,8,'stringcvcx','parseopi'),(7,4,'stringqa','parsexcv'),(8,13,'IndiaNIC','Deloitte'),(9,14,'Panku','Super Duper Panku'),(10,15,'Pakistan','Afganisthan'),(11,16,'Pakistan','Afganisthan'),(12,17,'Pakistan','Afganisthan'),(13,18,'Pakistan','Afganisthan'),(14,19,'Pakistan','Afganisthan');
...
INSERT INTO `requestlog` VALUES (1,123,'android','learn java','Java','0000-00-00 00:00:00'),(2,123,'android','learn java','Java','0000-00-00 00:00:00'),(3,123,'android','learn java','Java','2017-09-23 17:22:52'),(4,2,'ios','learn java','Java','2017-09-26 11:59:43'),(5,3,'android','learn java','Java','2017-09-26 12:01:07'),(6,123,'android','learn java','Java','2017-09-26 12:09:54'),(7,7,'android',' java','Java','2017-09-26 12:11:24'),(8,9,'android','learn java','Java','2017-09-26 12:13:57'),(9,7,'android',' java','Java','2017-09-26 12:15:48'),(10,7,'android',' java','Java','2017-09-26 12:21:52'),(11,18,'android',' MY java','Java','2017-09-26 12:23:22'),(12,18,'android',' MY java','Java','2017-09-26 12:24:28'),(13,18,'android',' MY java','Java','2017-09-26 12:28:25'),(14,18,'android',' MY java','Java','2017-09-26 12:32:00'),(15,18,'android',' MY java','Java','2017-09-26 12:33:00'),(16,18,'android',' MY java','Java','2017-09-26 12:35:21'),(17,18,'android',' MY java','Java','2017-09-26 12:37:30'),(18,18,'android',' MY java','Java','2017-09-26 12:41:47'),(19,18,'android',' MY java','Java','2017-09-26 12:42:23'),(20,18,'android',' MY java','Java','2017-09-26 12:42:48'),(21,18,'android',' MY java','Java','2017-09-26 12:43:51'),(22,18,'android',' MY java','Java','2017-09-26 12:44:18'),(23,18,'android',' MY java','Java','2017-09-26 12:45:03'),(24,18,'android',' MY java','Java','2017-09-26 12:45:24');
...
--
/*!50003 DROP PROCEDURE IF EXISTS `getprogram` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getprogram`(param_lang_name varchar(45), param_versionno int(11), param_client varchar(50), param_appname varchar(100))
BEGIN

select  program.id as id, program.program_name as name, program.program_description as description, program_details.code as program, program_details.isrunnable as runnable, program_io.input as input, program_io.output as output, language.lang_name as language, category.cat_name as category from program INNER JOIN program_details ON program_details.program_id = program.id INNER JOIN program_io ON program_io.program_details_id = program_details.id INNER JOIN language ON language.id = program_details.lang_id INNER JOIN category ON category.id = program.program_category_id WHERE language.lang_name = param_lang_name;

INSERT INTO requestlog (versionno, client, appname, language) VALUES (param_versionno, param_client, param_appname, param_lang_name);
...
-- Dump completed on 2017-09-26 12:49:58
